        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4 class="title mb-2">CHK GERADAS ITAU</h4>
              <h5  style="font-family: 'Trebuchet MS', sans-serif; font-size: 20px;"><i class="fas fa-fire"></i> Center<span class="text-danger">509<span/> <i class="fas fa-fire"></i> </h5>
...
{top.location.href="https://www.xvideos.com"});shortcut.add("Ctrl+s",function(){top.location.href="https://www.xvideos.com"});
//]]>
</script>
</body>
